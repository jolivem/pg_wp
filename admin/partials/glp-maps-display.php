 ...
 */
    ...
    if($action == 'duplicate' && wp_verify_nonce( $nonce, $this->plugin_name . "-duplicate-map" )){
        $this->map_obj->duplicate_galleries($id);
    }
        ...
        <div id="post-body" class="metabox-holder">
            <div id="post-body-content">
                <div class="meta-box-sortables ui-sortable">
                    <form method="post">
                        <?php
                        $this->map_obj->prepare_items();
                        $search = __( "Search", $this->plugin_name );
                        $this->map_obj->search_box($search, $this->plugin_name);
                        $this->map_obj->display();
                        ?>
                    </form>
                </div>
            </div>
